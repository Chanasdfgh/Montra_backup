...
<head>
  ...
  <title>Completed Bookings | Montra Studio</title>
  ...
  <style>
    ...
    .badge.completed { background:#007bff; } /* blue badge for completed */

    /* Dropdown & header styles preserved */
    ...
    .nav-icons { display: flex; align-items: center; gap: 5px; }
  </style>
</head>
<body>
  <!-- HEADER -->
  ...
  <main>
    <section class="booking-section">
      ...
      <?php if (empty($completed_bookings)): ?>
        <p style="margin-top:10px; color:#666;">You currently have no completed bookings.</p>
      <?php else: ?>
