...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    // ✅ Safe fallback values if no data found
    $package = [
        'name' => 'Package Not Found',
        'description' => 'This package does not exist or may have been removed.',
        'price' => 0,
  ...
  <section class="service-package">
    <div class="package-card">
      <div class="package-img">
        <img src="../uploads/<?= htmlspecialchars($package['main_image'] ?: 'default.jpg') ?>" alt="Couple Package">
      </div>
    ...
    <div class="carousel">
      <?php if (!empty($images)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <p style="text-align:center; color:#777;">No images available for this package.</p>
      <?php endif; ?>
    </div>
  </section>
  ...
  <div class="package-details">
    ...
    <ul>
      <?php if (!empty($includes)): ?>
        ...
        <?php endforeach; ?>
      <?php else: ?>
        <li>No items listed for this package.</li>
      <?php endif; ?>
    </ul>
  </div>
